                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            ...
                            <form action ="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post">
                                <select class="form-control mb-2" style="width:200px;" name="selected_class">
                            ...
                            <?php
                                     if($_SESSION['is_admin'] == true){
                                        if(isset($_POST['showTableBtn'])){
                                            ...
                                            echo '
                                                <p class="h5 text-center mt-5"><strong> Klasa '.$classes_list[$_POST["selected_class"]].'</strong><p>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table>
                        <tr>
                            <td style="height: 73px;"><p class="pr-1 pl-3 pt-1">Wybierz przedmiot</p></td>
                            <td>
                                <form method="POST">
                                <select class="form-control mb-2" name="selected_subject">
                                <?php
                                     if($_SESSION['is_admin'] == true){
                                        $classes_list;
