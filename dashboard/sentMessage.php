    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Wysłane wiadomości</h1>
            </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover row-clickable" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php
                                $query = "SELECT * FROM " . $prefix . "_messages where sender_id = " . $_SESSION['user_id'] . " and deleted_by_sender=0 ORDER BY date desc;";
                                $result = mysqli_query($link, $query) or die("Zapytanie zakończone niepowodzeniem");

                                foreach ($result as $odebrana_wiadomosc) {
                                    $query2 = "SELECT * FROM ".$prefix."_users where user_id = " . $odebrana_wiadomosc['receiver_id'] . ";";
                                    $result2 = mysqli_query($link, $query2) or die("Zapytanie zakończone niepowodzeniem");

                                    while ($receiver = mysqli_fetch_assoc($result2)) {
                                        echo '
                                        <tr>
                                            <td class="custom_td"><a class="clickable" href="detailsMessage.php?type=sent&id='.$odebrana_wiadomosc['message_id'].'">' . $receiver['first_name'] . ' ' . $receiver['last_name'] . '</a></td>
                                            <td class="custom_td"><a class="clickable" href="detailsMessage.php?type=sent&id='.$odebrana_wiadomosc['message_id'].'">' . $odebrana_wiadomosc["subject"] . '</a></td>
                                            <td class="custom_td"><a class="clickable" href="detailsMessage.php?type=sent&id='.$odebrana_wiadomosc['message_id'].'">' . $odebrana_wiadomosc["date"] . '</a></td>
                                            <td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="messages/removeMessageSent.php" method="post">
